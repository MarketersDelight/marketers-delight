<article class="md-collection-item" data-md-collection-item="<?php echo esc_attr( $item->ID ); ?>">
	...
	<div data-md-collection-summary>
		...
		<p class="md-collection-actions">
			...
			<?php if ( $item->post_status === 'publish' && $permalink ) : ?><a href="<?php echo esc_url( $permalink ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'View', 'md' ); ?></a><?php endif; ?>
			<?php if ( $edit_link ) : ?><a href="<?php echo esc_url( $edit_link ); ?>" class="dashicons-before dashicons-external" target="_blank" rel="noopener"><?php esc_html_e( 'Edit', 'md' ); ?></a><?php endif; ?>
	...
	<div data-md-collection-editor hidden>
		<?php echo $collection->render_fields( $item->ID ); ?>
