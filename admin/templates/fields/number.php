...
<?php echo $prefix; ?><input type="number" class="regular-text<?php echo esc_attr( $classes ); ?>" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $id ); ?>" value="<?php echo esc_attr( $option ); ?>"<?php echo $placeholder . $style . $max . $disabled; ?> /><?php echo $unit; ?>
