...
<p style="margin-top: 0; font-style: italic;"><?php echo __( 'Advanced: you can filter posts to only show when a term matches a term on the current page.', 'md' ); ?></p>

<div class="md-auto-filter-manual" style="<?php echo ! empty( $val['auto_filter'] ) ? 'display: none;' : ''; ?>">
    <label for="<?php echo $this->get_field_id( 'filter_term' ); ?>"><?php echo __( 'Filter by term ID', 'md' ); ?>:</label>
...
<p>
    ...
    <label for="<?php echo $this->get_field_id( 'auto_filter' ); ?>"><?php echo __( '...or auto-detect from taxonomy', 'md' ); ?></label>
</p>
...
<p>
    ...
    <span class="description"><?php echo __( 'Exclude category IDs, comma-separated.', 'md' ); ?></span>
</p>
...
<p>
    ...
    <span class="description" style="padding:0"><?php echo __( '<b>Default:</b> <i>All {count} {category} &rarr;</i>', 'md' ); ?></span>
</p>
