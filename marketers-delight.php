...
final class marketers_delight {
	...
	public function includes() {
		...
		include_once MD_DIR . 'functions/image-functions.php';
		include_once MD_DIR . 'functions/post-functions.php';
		include_once MD_DIR . 'functions/loop-functions.php';
...
//		require_once( md_template( 'hero', true ) );
		...
		if ( function_exists( 'register_block_type' ) && ! md_setting( array( 'content', 'post', 'blocks' ) ) )
			require_once( MD_DIR . 'classes/blocks.php' );
		$this->dropins();
	}
