<?php
/**
 * Cleans up old and unneeded features of WordPress, mostly
 * by removing junk from the <head> and other annoyances.
 *
 * @since 4.9.4
 */
...
class md_optimize_wp {
	...
	public function __construct() {
		add_filter( 'comment_form_fields', array( $this, 'comment_form_reorder' ) );
	...
	function comment_form_reorder( $fields ) {
