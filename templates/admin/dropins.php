<div class="md-dropins md-content-wrap-med">
	...
	<div class="md-dropins-list md-tabs md-sep-small">
		...
		<?php if ( ! empty( $installed ) ) : foreach ( $installed as $dropin => $fields ) :
		...
		foreach ( array( 'move_dropins', 'migrate_dropins', 'moved_dropins' ) as $dropin_status )
			$this->fields->field( $dropin_status, array(
				'type' => 'text',
				'hidden' => true
			) );
