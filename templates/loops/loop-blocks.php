		...
		<article id="post_<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="content-inner">
				<?php if (!empty($image)) : ?>
					<div class="featured-image">
						<a href="<?php the_permalink(); ?>"
						   title="<?php echo esc_attr(sprintf(__('Permalink to %s', 'md'), the_title_attribute('echo=0'))); ?>"
						   rel="bookmark">
				...
				<div class="post-content">
					<div class="content-headline">
						...
						<?php endif; ?>
						<h1 class="headline<?php echo md_has_sidebar() ? ' med-title' : ''; ?>"><a
									href="<?php the_permalink(); ?>"
									title="<?php echo sprintf(__('Permanent Link to %s', 'md'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a>
						</h1>
					</div>
					<?php if ($content !== 'hide') : ?>
			...
			<div class="content-footer <?php echo md_byline_classes(); ?>">
				...
				<div class="content-footer-author">
					...
					<?php endif; ?>
					<a href="<?php the_permalink(); ?>"
					   class="more-link button button-small mr-small"><?php echo esc_html(md_read_more_text()); ?></a>
