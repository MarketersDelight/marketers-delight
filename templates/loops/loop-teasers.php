		...
		?>
			<article id="post_<?php the_ID(); ?>" <?php post_class( $post_class ); ?>>
				...
				<div class="<?php echo md_teaser_classes(); ?>">
					...
					<h1 class="headline <?php echo in_array( 'featured-col', $post_class ) ? 'med-title': 'teaser-title'; ?>"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'md' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
