<a href="<?php echo esc_html( $url ); ?>" class="share-button share-<?php echo esc_attr( $share ); ?><?php echo esc_attr( $class ); ?>" style="<?php echo $color_prop; ?>: <?php echo esc_attr( $color ); ?>;<?php echo $style_class == 'bold' ? 'width: ' . ( 100 / $count ) . '%;' : ''; ?>"<?php echo $action; ?>>
