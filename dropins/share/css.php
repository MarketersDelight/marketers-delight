<style type="text/css">
    ...
    .share-count, .share-comment-count {
        font-size: 0.8em;
    }
    ...
    .share-minimal:first-child, .style-default .content-text + .share-minimal {
        border-top: 0;
    }
    ...
    .style-minimal .share-minimal:first-child {
        padding-top: 0;
    }

    .style-default .post-box .share-minimal {
    ...
    .share-minimal .share-comments .share-icon {
    ...
    @media all and (min-width: <?php echo $site_width; ?>px) {
        ...
        .content-sidebar.sidebar-left .share-sticky.inline .share-button, .share-sticky.side-left .share-button {
            box-shadow: inset 3px 0 2px rgba(0, 0, 0, 0.15);
        }

        .content-sidebar.sidebar-left .share-sticky.inline .share-button:first-child, .share-sticky.side-left .share-button:first-child {
            border-radius: 0 3px 0 0;
        }

        .content-sidebar.sidebar-left .share-sticky.inline .share-button:last-child, .share-sticky.side-left .share-button:last-child {
    ...
    @media all and (max-width: 900px) {
        ...
        .style-minimal .content-headline + .share {
