<div class="md-content-wrap-med">
    ...
    <p>
        ...
        <a href="<?php echo admin_url('customize.php?autofocus[panel]=woocommerce'); ?>"
           class="button button-secondary md-button" target="_blank"><?php echo __('WooCommerce Settings', 'md'); ?></a>
    </p>
</div>