<style type="text/css">
    ...
    .woocommerce .loop-default.style-default .post-box > div {
        border-bottom: 0;
    }
    ...
    @media all and (max-width: <?php echo $site_width; ?>px) {
        .woocommerce .style-minimal .site-main {
    ...
    .featured-image-cover .header-cart {
        color: <?php echo ( ! empty( $content['featured_image']['styles']['text_color'] ) ? $colors['site']['headline'] : '#FFFFFF' ); ?>;
    }
    ...
    .content .cart-empty, .content .cart-empty + .return-to-shop {
        text-align: center;
    }
    ...
    .woocommerce .shop_table button.button:disabled, .woocommerce .shop_table button.button:disabled:hover {
    ...
    .woocommerce div.product .woocommerce-tabs ul.tabs li a, .woocommerce p.stars a {
        border-bottom: 0;
    }
    ...
    .woocommerce p.stars a:not(:last-child) {
    ...
    .woocommerce .woocommerce-checkout .col-1, .woocommerce-form-coupon-toggle {
        margin-bottom: <?php echo $single; ?>px;
    }
    ...
    .widget_price_filter button[type="submit"], .widget_price_filter button[type="submit"]:hover {
        background-color: <?php echo $colors['site']['button-sec']; ?>;
    }
    ...
    .woocommerce-widget-layered-nav-list__item--chosen {
        border: 1px solid<?php echo $colors['site']['primary']; ?>;
    }
    ...
    @media all and (max-width: <?php echo $site_width; ?>px) {
        ...
        /* CONTENT */
        .woocomerce .style-minimal .site-main {
            padding: <?php echo $half; ?>px;
        }
    }

    @media all and (max-width: 768px) {
        .woocommerce .woocommerce-ordering, .woocommerce-page .woocommerce-ordering, .woocommerce div.product form.cart div.quantity {
            float: none;
        }
