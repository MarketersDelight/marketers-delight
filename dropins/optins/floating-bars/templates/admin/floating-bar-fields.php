<div class="md-tabs md-conditional">
	<div class="nav-tab-wrapper">
		<a href="#" class="md-tab nav-tab nav-tab-active"
		   data-md-tab="floating-bar-content"><?php echo __('Content', 'md'); ?></a>
	...
	<div class="floating-bar-content md-tab-content active">
		...
		<div class="md-conditional-item md-conditional-image md-sep-small"
			 style="display: <?php echo $media_type == 'image' ? 'block' : 'none'; ?>">
		...
		<div class="md-conditional-item md-conditional-icon md-sep-small"
			 style="display: <?php echo $media_type == 'icon' ? 'block' : 'none'; ?>">
	...
	<div class="floating-bar-cta md-tab-content">
		...
		<div class="floating-button md-conditional-item md-conditional-button md-sep-small"
			...
			<div class="floating-button-url columns-2 columns-single md-sep-small"
			...
			<div class="floating-button-popup md-sep-small"
		...
		<div class="md-conditional-item md-conditional-email"
	...
	<div class="floating-bar-display md-tab-content">
		...
		<div class="floating-bar-display-options md-optins-show-fields columns-2 columns-single md-sep-small"
			 style="display: <?php echo $position != 'before_footer' ? 'block' : 'none'; ?>">
			<div class="col md-sep-small">
	...
	<div class="floating-bar-design md-tab-content">
		...
		<div class="md-conditional-item md-conditional-image columns-2 columns-single md-sep-small"
			 style="display: <?php echo $media_type == 'image' ? 'block' : 'none'; ?>">
			<div class="col">
