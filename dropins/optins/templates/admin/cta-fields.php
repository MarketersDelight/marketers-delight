<div class="md-tabs md-conditional">
	...
	<div class="cta-form md-tab-content">
		...
		<div class="cta-button md-conditional-item md-conditional-button md-sep-small" style="display: <?php echo $cta_type == 'button' ? 'block' : 'none'; ?>">
			<hr />
...
//						'close' => __( 'Close Floating Bar', 'md' )
			...
			<div class="cta-button-group columns-2 columns-single md-sep-small" style="display: <?php echo in_array( $button_type, array( 'url', 'popup', 'close' ) ) ? 'block' : 'none'; ?>">
				<div class="col">
				...
				<div class="col">
					<div class="cta-button-url md-sep-small" style="display: <?php echo $button_type == 'url' ? 'block' : 'none'; ?>">
					...
					<div class="cta-button-popup md-sep-small" style="display: <?php echo $button_type == 'popup' ? 'block' : 'none'; ?>">
		...
		<div class="cta-form md-conditional-item md-conditional-email" style="display: <?php echo $cta_type == 'email' ? 'block' : 'none'; ?>">
			<hr />
		...
		<div class="md-conditional-item md-conditional-html" style="display: <?php echo $cta_type == 'html' ? 'block' : 'none'; ?>">
			<hr />
