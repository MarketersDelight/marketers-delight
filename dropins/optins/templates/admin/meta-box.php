<div class="md-tabs md-conditional">
	<div class="nav-tab-wrapper">
		<a href="#" class="md-tab nav-tab nav-tab-active" data-md-tab="md-optins-cta"><?php echo __( 'Call to Action', 'md' ); ?></a>
		<a href="#" class="md-tab nav-tab" data-md-tab="md-optins-floating-bars"><?php echo __( 'Floating Bars', 'md' ); ?></a>
