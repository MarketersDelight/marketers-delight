				...
				<div class="md-widget md-toggle md-sep-small">
					...
					<div class="md-widget-item">
						<?php if ( md_setting( 'popups' ) ) : ?>
							...
							<div id="popups_byline_row" class="md-sep-micro" style="display: <?php echo ! empty( $byline_text ) ? 'block' : 'none'; ?>">
							...
							<div id="popups_header_menu_row" style="display: <?php echo ! empty( $header_menu ) ? 'block' : 'none'; ?>">
								<div class="md-sep-micro">
