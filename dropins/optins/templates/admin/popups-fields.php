<div class="md-popup-content">
	<div class="md-sep-micro">
		<a href="<?php echo admin_url( 'customize.php?autofocus[section]=marketers_delight[popups_data][' . esc_attr( $field ) . ']' ); ?>" target="_blank" class="button button-primary"><i class="dashicons dashicons-edit"></i> <?php echo __( 'Edit in Customizer', 'md' ); ?></a>&nbsp;
		<a class="button md-popup-button-shortcode" onClick="window.prompt( 'Copy (ctrl + c + enter) and paste shortcode anywhere on your site.', '[md_popup id=&quot;<?php echo $field; ?>&quot; type=&quot;button&quot; text=&quot;Open popup&quot;]' )"><i class="dashicons dashicons-editor-code"></i> <?php echo __( 'Copy Shortcode', 'md' ); ?></a>
	</div>
