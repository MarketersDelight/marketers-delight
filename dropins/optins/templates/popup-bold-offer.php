<div id="md_popup_<?php echo esc_attr( $fields['id'] ); ?>" class="<?php echo esc_attr( $fields['classes'] ); ?>"<?php echo md_style( array( 'bg_color' => $fields['bg_color'], 'border_color' => $fields['border_color'], 'color' => $fields['text_color'], 'bg_image' => $fields['bg_image'], 'bg_size' => $fields['bg_repeat'] ) ); ?>>
