<style type="text/css">
	...
	.content-box .content .cta-box.post-box {
		padding: 0;
	}
	...
	@media all and (min-width: 900px) {
		.content-full .cta-slim .cta-inner, .cta-full .cta-inner {
			padding: <?php echo $double; ?>px <?php echo $quad; ?>px;
		}
		...
		.cta-small .image-left {
			margin-right: <?php echo $half; ?>px;
		}

		.cta-small .image-right {
			margin-left: <?php echo $half; ?>px;
		}
	}
	...
	.popup-title:empty, .popup-subtitle:empty, .popup-text:empty, .popup-buttons-text:empty {
		display: none;
	}

	.popup-content, .popup-image-wrap {
		position: relative;
	}
	...
	.md-popup .button-text, .md-popup .button-subtext {
		display: block;
	}
	...
	@media all and (max-width: 700px) {
		.popup-default .popup-image, .popup-border-box .popup-image {
			width: 50% !important;
		}
	...
	.popup-grail .popup-secondary-bg-color {
		background-color: #1e1e1e;
	}

	.popup-grail .popup-image-wrap {
		text-align: center;
	}
	...
	@media all and (min-width: 800px) {
		...
		.popup-grail.image-alignleft .popup-content, .popup-grail.image-alignright .popup-content {
			width: 60%;
		}

		.popup-grail.image-alignleft .popup-image-wrap, .popup-grail.image-alignright .popup-image-wrap {
			width: 40%;
		}

		.popup-grail.image-aligncenter .popup-image {
			margin-top: -<?php echo $single; ?>px;
		}

		.popup-grail.image-alignleft .popup-content {
			padding-left: <?php echo $triple; ?>px;
		}

		.popup-grail.image-alignright .popup-image-wrap {
			order: 2;
		}

		.popup-grail.image-alignleft .popup-image {
			right: -<?php echo $mid; ?>px;
		}

		.popup-grail.image-alignright .popup-content {
			padding-right: <?php echo $triple; ?>px;
		}

		.popup-grail.image-alignright .popup-image {
			left: -<?php echo $mid; ?>px;
		}
	...
	@media all and (max-width: 800px) {
		...
		.popup-grail.has-image .popup-content {
	...
	.popup-bold-offer .popup-subtitle, .popup-bold-offer .md-popup-close-corner {
		color: #fff;
	}
	...
	.popup-bold-offer .form-full.form-multi-fields .form-input {
		float: left;
	}
	...
	@media all and (min-width: 700px) {
		...
		.popup-bold-offer .button + .button, .popup-bold-offer .form-full.form-multi-fields .form-input + .form-input {
			margin-left: 2%;
		}
	...
	.popup-notification.image-aligncenter {
		text-align: center;
	}
	...
	.admin-bar .cta-bar.floating.top, .has-md-admin-bar .cta-bar.floating.top {
		top: 32px;
	}
	...
	.cta-bar-full .cta-bar-corner {
		right: <?php echo $small; ?>px;
	}
	...
	.cta-bar-media.breakout {
		vertical-align: bottom;
	}

	.cta-bar-media.has-shadow .cta-bar-image {
		box-shadow: 0 5px 25px rgba(0, 0, 0, 0.2);
	}
	...
	@media all and (min-width: 900px) {
		...
		.cta-bar-media {
			padding-right: <?php echo ( $half + $third ); ?>px;
		}
	...
	@media all and (max-width: 900px) {
		...
		.cta-bar-content, .cta-bar-action {
			width: 100% !important;
		}
