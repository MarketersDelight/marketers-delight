<div id="md_popup_<?php echo esc_attr($fields['id']); ?>"
     class="<?php echo esc_attr($fields['classes'] . ' image-' . $fields['featured_image']['alignment']['center']); ?>"<?php echo md_style(array('bg_color' => $fields['bg_color'], 'border' => array(7, 'solid', $fields['border_color']), 'color' => $fields['text_color'])); ?>>
