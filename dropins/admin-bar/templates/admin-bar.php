<div id="md_admin_bar" class="md-admin-bar">
	...
	<ul class="md-admin-bar-actions menu">
		...
		<li class="md-admin-bar-item menu-item">
			<a href="<?php echo get_admin_url(); ?>" class="md-admin-bar-link" target="_blank"><i class="md-icon-wordpress mr-small"></i> <?php echo __( 'Admin', 'md' ); ?></a>
		</li>
	
		<?php if ( ! empty( $edit_url ) ) : ?>
			<li class="md-admin-bar-item menu-item">
				<a href="<?php echo esc_url( $edit_url ); ?>" class="md-admin-bar-link" target="_blank"><i class="md-icon-pencil mr-small"></i> <?php echo __( 'Edit', 'md' ); ?></a>
			</li>
		<?php endif; ?>
	
		<li class="md-admin-bar-item menu-item menu-item-sep menu-item-has-children">
			<a href="#" class="md-admin-bar-link"><i class="md-icon-star mr-small"></i> <?php echo __( 'New', 'md' ); ?></a>
			<ul class="sub-menu">
	...
	<ul class="md-admin-bar-links menu">
		...
		<li class="md-admin-bar-item menu-item menu-item-right">
			<a href="<?php echo wp_logout_url(); ?>" class="md-admin-bar-link"><i class="md-icon-eye mr-small"></i> <?php echo __( 'Logout', 'md' ); ?></a>
		</li>

		<li class="md-admin-bar-item menu-item menu-item-right">
			<a href="<?php echo admin_url( 'profile.php' ); ?>" class="md-admin-bar-link"><i class="md-icon-user mr-small"></i> <?php echo esc_html( $display_name ); ?></a>
		</li>
