	...
	<cite class="footnote-text<?php echo $align; ?>">
		...
		<span class="footnote-triggers">
			<?php if ( ! empty( $footnotes['after_post']['show'] ) ) : ?>
				<a href="<?php echo $url; ?>#footnotes" class="footnote-trigger-list <?php echo md_icon( 'menu', true ); ?>"></a>
			<?php endif; ?>
			<span class="footnote-trigger-close">&times;</span>
		</span>
	</cite>
</span>
<?php if ( $i == 1 ) wp_add_inline_script( 'marketers-delight', "\tMD.footnotes();" ); $i++; ?>