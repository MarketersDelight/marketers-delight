	...
	<div class="stream-head-content<?php echo esc_attr($col2); ?>">
		...
		<?php elseif ($context == 'widget' && $archives_title) : ?>
			...
			<?php if (!is_post_type_archive('stream')) : ?>
				<p class="stream-head-title<?php echo esc_attr($title_classes); ?>"><a
							href="<?php echo get_post_type_archive_link('stream'); ?>"><?php echo md_text_field($archives_title); ?></a>
				</p>
			<?php else : ?>
		...
		<div class="stream-stats">
			<span class="stream-stat stat-posts mr-half">
				...
				<b class="stat-count"><?php echo esc_attr($posts_count); ?></b> <span
						class="stat-text"><?php echo __('Posts', 'md'); ?></span>
			</span>
			<span class="stream-stat stat-likes">
				<?php echo md_icon('heart-empty', array('classes' => 'stat-icon')); ?>
				<b class="share-total" data-share-total="stream"><?php echo esc_attr($likes_count); ?></b> <span
						class="stat-text"><?php echo __('Likes', 'md'); ?></span>
			</span>
		</div>
	</div>
</div>
