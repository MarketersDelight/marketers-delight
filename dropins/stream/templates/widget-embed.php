			...
			?>
				...
				<div class="stream-widget-post">
					...
					<?php if ( get_the_title() && empty( $val['hide_title'] ) ) : ?>
						<p class="stream-widget-title mb-small"><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a></p>
					<?php endif; ?>
					...
					<div class="stream-widget-byline clear">
						...
						<span class="stream-byline-date"><a href="<?php echo get_permalink(); ?>"><?php echo $date; ?></a></span>
						<?php if ( md_has( 'share' ) ) : ?>
