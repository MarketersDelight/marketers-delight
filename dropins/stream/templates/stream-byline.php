<div class="byline">
    ...
    <?php else : ?>
        <?php echo md_icon('share', array('classes' => 'mr-small')); ?><?php echo get_the_author_meta('first_name', $post_author); ?><?php echo sprintf(__(' shared a %s', 'md'), '<b>' . (isset($types[$post_type]) ? $types[$post_type]['label'] : $post_type) . '</b>'); ?><?php echo $label; ?>
        <a href="<?php echo get_permalink($post_id); ?><?php echo $html_id; ?>"><?php echo $date; ?></a>
    <?php endif; ?>
    ...
    <?php else :
        ...
        <span class="stream-byline-date"><a
                    href="<?php echo get_permalink($post_id); ?><?php echo $html_id; ?>"><?php echo $date; ?></a></span>
