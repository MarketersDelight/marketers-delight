<div id="md_popup_bookshelf_<?php echo esc_attr( $post['post_id'] ); ?>" class="md-popup md-popup-bookshelf block-mid format">
	<div class="columns-30-70 columns-single">
		<div class="col col1 mb-single text-center">
			...
			<?php if ( ! empty( $post['download_url'] ) ) : ?>
				<p><a href="<?php echo esc_url( $post['download_url'] ); ?>" class="button button-small button-radio width-full" target="_blank"><?php echo $post['default_text']; ?></a></p>
			<?php endif; ?>
		</div>
		<div class="col col2">
