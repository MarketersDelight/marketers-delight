...
function md_icons( $show_defaults = null ) {
	$icons = array(
		...
		'facebook' => array(
			...
			'classes' => array( 'facebook-squared' )
		),
		'flickr' => array(
			'unicode' => 'e80a',
			'label' => __( 'Flickr', 'md' )
		...
		'linkedin' => array(
			...
			'classes' => array( 'linkedin-squared' )
		),
		'loading' => array(
			'unicode' => 'e832',
			'label' => __( 'Loading', 'md' )
		...
		'ok' => array(
			'unicode' => 'e804',
			'label' => __( 'OK', 'md' ),
			'classes' => array( 'ok-circled', 'list-check li' )
		),
		'pencil' => array(
			'unicode' => 'e80d',
			'label' => __( 'Pencil', 'md' )
		...
		'pinterest' => array(
			...
			'classes' => array( 'pinterest-squared' )
		),
		'quote' => array(
			'unicode' => 'f10e',
			'label' => __( 'Quote', 'md' )
