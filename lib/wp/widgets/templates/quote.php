...
<p>
    ...
    <textarea id="<?php echo $this->get_field_id('quote'); ?>" name="<?php echo $this->get_field_name('quote'); ?>"
              rows="8" class="large-text"><?php echo esc_attr($val['quote']); ?></textarea>
</p>

<p>
    <label for="<?php echo $this->get_field_id('author'); ?>"><?php _e('Quote Author', 'md'); ?>:</label>

    <input type="text" id="<?php echo $this->get_field_id('author'); ?>"
           name="<?php echo $this->get_field_name('author'); ?>" value="<?php echo esc_attr($val['author']); ?>"
           class="widefat"/>
</p>
