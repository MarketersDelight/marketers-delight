...
<p>
    ...
    <textarea id="<?php echo $this->get_field_id('desc'); ?>" name="<?php echo $this->get_field_name('desc'); ?>"
              rows="8" class="large-text"><?php echo esc_attr($val['desc']); ?></textarea>
</p>

<p>
    <label for="<?php echo $this->get_field_id('button_link'); ?>"><?php _e('Link', 'md'); ?>:</label>

    <input type="text" class="widefat" name="<?php echo $this->get_field_name('button_link'); ?>"
           id="<?php echo $this->get_field_id('button_link'); ?>" value="<?php echo $val['button_link']; ?>">
</p>

<p>
    <label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e('Button Text', 'md'); ?>:</label>

    <input type="text" id="<?php echo $this->get_field_id('button_text'); ?>"
           name="<?php echo $this->get_field_name('button_text'); ?>"
           value="<?php echo esc_attr($val['button_text']); ?>" class="widefat"/>
</p>
