...
<div id="<?php echo $this->get_field_id( 'name_label' ); ?>-field" style="display: <?php echo $val['form_fields_name'] ? 'block' : 'none'; ?>">
	...
	<input type="text" id="<?php echo $this->get_field_id( 'name_label' ); ?>" name="<?php echo $this->get_field_name( 'name_label' ); ?>" value="<?php esc_attr_e( $val['name_label'] ); ?>" placeholder="<?php echo __( 'Enter your name&hellip;', 'md' ); ?>" class="widefat" />
...
<p>
	...
	<input type="text" id="<?php echo $this->get_field_id( 'email_label' ); ?>" name="<?php echo $this->get_field_name( 'email_label' ); ?>" value="<?php esc_attr_e( $val['email_label'] ); ?>" placeholder="<?php echo __( 'Enter your email&hellip;', 'md' ); ?>" class="widefat" />
</p>
...
<?php if ( ! empty( $data['enabled']['aweber'] ) || ! empty( $data['enabled']['mailerlite'] ) ) : ?>
	<p>
		...
		<input type="text" id="<?php echo $this->get_field_id( 'email_thank_you' ); ?>" name="<?php echo $this->get_field_name( 'email_thank_you' ); ?>" value="<?php esc_attr_e( $val['email_thank_you'] ); ?>" class="widefat" placeholder="<?php echo get_site_url(); ?>/thank-you/" />
