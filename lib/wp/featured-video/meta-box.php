...
<div id="featured_video_options" style="display: <?php echo ! empty( $meta['service'] ) ? 'block' : 'none'; ?>">
	...
	<?php foreach ( $videos as $id => $fields ) : ?>
		<div id="featured_video_<?php echo $id; ?>_row" class="md-sep-small" style="display: <?php echo ! empty( $meta['service'] ) && $meta['service'] == $id ? 'block' : 'none'; ?>">
	...
	<div id="featured_video_embed_row" class="md-sep-small" style="display: <?php echo ! empty( $meta['service'] ) && $meta['service'] == 'embed' ? 'block' : 'none'; ?>">
