	 ...
	 ?>
		<div class="md-tabs">
			<div class="nav-tab-wrapper">
				<?php $c = 0; foreach ( $page_settings as $id => $label ) : ?>
					<a href="#" class="md-tab nav-tab<?php echo $c == 0 ? ' nav-tab-active' : ''; ?>" data-md-tab="md-<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $label ); ?></a>
				<?php $c++; endforeach; ?>
			</div>
