			...
			<div class="columns-3 columns-single columns-flex">
				<?php foreach ($this->dropins as $dropin => $fields) :
					...
					<div class="col<?php echo $is_installed ? ' md-store-item-installed' : ''; ?>">
						<a href="<?php echo $fields['url']; ?>" target="_blank" class="md-store-item-image"><img
									src="<?php echo $fields['image']; ?>"/></a>
						<div class="col-inner">
							<h3><a href="<?php echo $fields['url']; ?>" target="_blank"><?php echo $fields['name']; ?>
									<small><?php echo $fields['version']; ?></small></a></h3>
							<?php if (isset($fields['description'])) : ?>
								<p><?php echo $fields['description']; ?></p>
							<?php endif; ?>
							<div class="md-store-item-byline md-clear">
								<a href="<?php echo $fields['url']; ?>" class="button"
								   target="_blank"><?php echo __('Get now', 'md'); ?></a>
								<?php if ($is_installed) : ?>
									<span class="md-store-item-status"><i
												class="dashicons dashicons-yes-alt"></i> <?php echo __('Installed', 'md'); ?></span>
								<?php endif; ?>
							</div>
						</div>
					</div>
