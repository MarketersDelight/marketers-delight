...
class md_upgrade
{
    ...
    public function admin_notice()
    {
        ...
        <div id="md_update_47_notice" class="notice notice-error">
            ...
            <p><a href="<?php echo admin_url("admin.php?page={$this->slug}"); ?>"
                  class="button button-primary"><?php echo __('Upgrade database &rarr;', 'md'); ?></a></p>
        </div>
    <?php }
                        ...
                        <div id="md47_<?php echo $process; ?>" class="md-box md-hide">
                            ...
                            <div class="md47-success md-hide">
                                ...
                                <span class="dashicons dashicons-yes"
                                      style="float: right; color: green; font-size: 27px;"></span>
