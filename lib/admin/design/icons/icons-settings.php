<div class="md-content-wrap md-sep-small">
	...
	<p><?php echo __( 'Customize the <a href="https://marketersdelight.com/docs/features/font-icons/" target="_blank">MD Icons library</a> with your own font icon set, and update default icons. ', 'md' ); ?></p>
