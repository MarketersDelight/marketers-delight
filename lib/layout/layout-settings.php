<div class="columns-2<?php echo ! in_array( $screen_base, array( 'post', 'post-new' ) ) ? ' columns-30-70' : ''; ?> columns-half">

	<div class="col col1">

		<div class="columns-2 columns-half">

			<?php do_action( "md_layout_{$post_base}_top" ); ?>

			<div class="col<?php echo ! in_array( $screen_base, array( 'post', 'post-new' ) ) ? ' col-full' : ''; ?> md-sep-small">
	...
	<div class="col col2">
		...
		<div class="columns-2 columns-half">
			...
			<div id="sidebar_fields" class="col" style="display: <?php echo empty( $content['remove'] ) ? 'block' : 'none'; ?>;">
