...
<?php else :
    ...
    <div class="featured-image-tax<?php echo $align; ?>">
        <img src="<?php echo esc_url($image); ?>"<?php echo $class; ?> width="<?php echo esc_attr($dim); ?>"
             height="<?php echo esc_attr($dim); ?>"/>
    </div>
