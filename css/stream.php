...
.stream-head .stream-head-title { margin-bottom: <?php echo $small; ?>px; }
...
.stream-item.sticky { padding-top: <?php echo $half; ?>px; }
...
.stream-excerpt:not(:last-child) { margin-bottom: <?php echo $half; ?>px; }
.stream-embed-content:not(:last-child) { margin-bottom: <?php echo $third; ?>px; }
...
.stream-widget-post:not(:last-child) { border-bottom: 1px solid <?php echo $colors['content']['border_color']; ?>; }
...
.stream-widget-title { font-weight: <?php echo $bold; ?> }

.widget_md_stream_widget .sidebar-title { margin-bottom: <?php echo $small; ?>px; }

.stream-widget .stream-widget-title a, .stream-widget .stream-byline-date a { text-decoration: none; }

.stream-widget-text {
	font-size: <?php echo $widget_fs; ?>px;
	line-height: <?php echo $widget_lh; ?>px;
}
.stream-widget-text ul, .stream-widget-text ol, .stream-widget-text p { margin-bottom: <?php echo $widget_lh; ?>px; }
.stream-widget-text ul, .stream-widget-text ol { margin-left: <?php echo $widget_lh; ?>px; }
...
@media all and (max-width: 900px) {
	...
	.stream-item { padding: <?php echo $half; ?>px; }
}