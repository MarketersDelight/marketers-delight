<style type="text/css">
    ...
    #editor .editor-post-title__block .editor-post-title__input, div.editor-styles-wrapper h1, div.editor-styles-wrapper h2, div.editor-styles-wrapper h3, div.editor-styles-wrapper h4, div.editor-styles-wrapper h5, div.editor-styles-wrapper h6 {
    ...
    div.editor-styles-wrapper p:last-child, div.editor-styles-wrapper p:empty {
        margin-bottom: 0;
    }
    ...
    div.editor-styles-wrapper p.huge-title, div.editor-styles-wrapper p.large-title, div.editor-styles-wrapper p.med-title, div.editor-styles-wrapper p.mid-title, div.editor-styles-wrapper p.micro-title, div.editor-styles-wrapper p.small-title {
        margin-top: 0;
    }
    ...
    <?php echo ! empty( $typography['body']['font_weight'] ) ? ' font-weight: ' . $typography['body']['font_weight'] . ';' : ''; ?> line-height: <?php echo $typography['body']['line_height']['desktop']; ?>px;
    }

    div.editor-styles-wrapper .has-huge-font-size, div.editor-styles-wrapper .has-large-font-size, div.editor-styles-wrapper .has-medium-font-size, div.editor-styles-wrapper .has-small-font-size {
        line-height: initial;
    }
    ...
    .text-center, .aligncenter.wrap-small {
        text-align: center;
    }
    ...
    @media all and (min-width: 900px) {
        ...
        .md-editor-full .editor-post-title__input {
            text-align: center;
        }
    }
    ...
    .has-shadow, .shadow, .wp-block-image.shadow img {
    ...
    .wp-block-image.shadow, .wp-block-image.shadow-small {
        box-shadow: none;
    }
    ...
    #editor .mt-quad {
        margin-top: <?php echo $quad; ?>px;
    }

    #editor .mb-quad {
        margin-bottom: <?php echo $quad; ?>px;
    }
    ...
    #editor .mb-triple {
        margin-bottom: <?php echo $triple; ?>px;
    }
    ...
    #editor .mr-double {
        margin-right: <?php echo $double; ?>px;
    }

    #editor .mb-double {
        margin-bottom: <?php echo $double; ?>px;
    }
    ...
    input.md-input-name {
        background-image: url('<?php echo MD_URL . 'lib/assets/images/user.png'; ?>');
    }

    input.md-input-email {
        background-image: url('<?php echo MD_URL . 'lib/assets/images/mail.png'; ?>');
    }

    .md-email-full .md-input, .md-email-full .md-submit {
        width: 100%;
    }

    .md-email-full .md-input {
        margin-bottom: <?php echo $half; ?>px;
    }

    [class*="md-email-attached"] .md-input, [class*="md-email-attached"] .md-submit {
        float: left;
    }
    ...
    .md-email-attached .md-input {
        width: 78%;
    }

    .md-email-attached-2 .md-input {
        width: 39%;
    }
    ...
    .md-content-upgrade-action .md-button {
        width: 100%;
    }
    ...
    .share-notice-full .md-submit-full {
        background-color: #fff;
    }
    ...
    .share-notice-twitter.share-notice-outline, .share-notice-twitter.share-notice-outline .md-submit-outline {
        border-color: #1da1f2;
        color: #1da1f2;
    }

    .share-notice-twitter.share-notice-full, .share-notice-twitter.share-notice-outline .md-submit-full {
        background-color: #1da1f2;
    }

    .share-notice-twitter.share-notice-outline .share-notice-icon, .share-notice-twitter.share-notice-full .md-submit-full {
        color: #1da1f2;
    }

    .share-notice-facebook.share-notice-outline, .share-notice-facebook.share-notice-outline .md-submit-outline {
        border-color: #3b5998;
        color: #3b5998;
    }

    .share-notice-facebook.share-notice-full, .share-notice-facebook.share-notice-outline .md-submit-full {
        background-color: #3b5998;
    }

    .share-notice-facebook.share-notice-outline .share-notice-icon, .share-notice-facebook.share-notice-full .md-submit-full {
        color: #3b5998;
    }

    .share-notice-pinterest.share-notice-outline, .share-notice-pinterest.share-notice-outline .md-submit-outline {
        border-color: #bd081c;
        color: #bd081c;
    }

    .share-notice-pinterest.share-notice-full, .share-notice-pinterest.share-notice-outline .md-submit-full {
        background-color: #bd081c;
    }

    .share-notice-pinterest.share-notice-outline .share-notice-icon, .share-notice-pinterest.share-notice-full .md-submit-full {
        color: #bd081c;
    }

    .share-notice-linkedin.share-notice-outline, .share-notice-linkedin.share-notice-outline .md-submit-outline {
        border-color: #0077b5;
        color: #0077b5;
    }

    .share-notice-linkedin.share-notice-full, .share-notice-linkedin.share-notice-outline .md-submit-full {
        background-color: #0077b5;
    }

    .share-notice-linkedin.share-notice-outline .share-notice-icon, .share-notice-linkedin.share-notice-full .md-submit-full {
        color: #0077b5;
    }
    ...
    .md-callout-title, .md-callout-action {
        text-align: center;
    }
    ...
    .md-callout-list + .md-callout-action {
        margin-top: <?php echo $single; ?>px;
    }

    .md-callout-action .md-button {
        width: 100%;
    }
