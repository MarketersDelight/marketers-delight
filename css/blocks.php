<style type="text/css">
	...
	.block {
		padding: <?php echo $single; ?>px <?php echo $double; ?>px;
	}
	...
	.block-single, .tagcloud, .note, .alert {
	...
	.block-double-top, .block-full-top {
		padding-top: <?php echo $double; ?>px;
	}
	...
	.block-double-content {
		padding: <?php echo $single; ?>px <?php echo $double; ?>px <?php echo $double; ?>px;
	}

	/* TRIPLE */

	.block-triple {
		padding: <?php echo $triple; ?>px;
	}
	...
	.block-triple-double {
		padding: <?php echo $triple; ?>px <?php echo $double; ?>px;
	}

	/* QUAD */

	.block-quad {
		padding: <?php echo $quad; ?>px;
	}
	...
	@media all and (max-width: 700px) {
		...
		.block-triple, .block-triple-double, .block-double, .block-mid, .block-double-content, .block {
			padding: <?php echo $single; ?>px;
		}
