<style type="text/css">
    ...
    @media all and (min-width: 900px) {
        .content-width {
            width: <?php echo ( ( $post_width / $site_width ) * 100 ); ?>%;
        <?php echo "/* ({$post_width} / {$site_width}) * 100 */"; ?>
        }
        ...
        .content-sidebar .content-inner {
            max-width: <?php echo ( ( $post_width / $content_width ) * 100 ); ?>%;
        <?php echo "/* ({$post_width} / {$content_width}) * 100 */"; ?>;
        }
        ...
        <?php echo "/* ({$content_width} / {$site_width}) * 100 */"; ?>
        }

        .sidebar {
            float: left;
            width: <?php echo ( ( $sidebar_width / $site_width ) * 100 ); ?>%;
        <?php echo "/* ({$sidebar_width} / {$site_width}) * 100 */"; ?>
        }
    ...
    .loop-default.style-default .post-box > .featured-image {
        border-bottom: 0;
    }

    .loop-default.style-default.content-sidebar .content-text {
    ...
    @media all and (min-width: 900px) {
        ...
        .loop-default.style-default .content-headline:last-child, .style-default .featured-image-cover {
            padding-bottom: <?php echo $double; ?>px;
        }

        .loop-default.style-default .content-headline {
            padding-top: <?php echo $double; ?>px;
        }

        .loop-default.style-default .content-headline + [class*="featured-"] {
            margin-top: <?php echo $double;?>px;
        }

        .style-default .featured-col .blog-teaser {
    ...
    @media all and (max-width: 900px) {
        ...
        .style-default .content-headline .content-inner {
            padding-top: <?php echo $single; ?>px;
        }

        .style-default.loop-default .content-headline + [class*="featured-"] {
            margin-top: <?php echo $single;?>px;
        }

        .style-default.loop-default .content-headline:last-child, .style-default .featured-image-cover .content-inner {
            padding-bottom: <?php echo $single; ?>px;
        }
    ...
    .style-minimal .content-headline {
    ...
    .style-minimal.loop-teasers .featured-image {
        margin-bottom: <?php echo $half; ?>px;
    }

    .style-minimal .share + .content-text {
        margin-top: <?php echo $single;?>px;
    }
    ...
    @media all and (min-width: 900px) {
        ...
        .style-minimal.loop-default .post-box {
        ...
        .style-minimal.content-sidebar .content-headline:not(:first-child) {
            padding-top: <?php echo $single; ?>px;
        }

        .style-minimal.content-full .content-headline:not(:first-child) {
            padding-top: <?php echo $double; ?>px;
        }

        .style-minimal.content-full .share + .content-text {
            margin-top: <?php echo $double;?>px;
        }

        .style-minimal.loop-default .content-text:not(:last-child) {
            padding-bottom: <?php echo $double; ?>px;
        }
    ...
    .loop-docs .col-style, .loop-docs .post-box {
        border-top: 5px solid<?php echo $colors['site']['primary']; ?>;
    }
    ...
    .loop-docs.style-default .col-head, .loop-docs.style-default .col-content {
        padding: <?php echo $half; ?>px;
    }
    ...
    .content-full.loop-docs .breadcrumbs {
        text-align: center;
    }
    ...
    .loop-teasers .teaser-title {
        margin-bottom: <?php echo $small; ?>px;
    }

    .loop-teasers .content .byline {
        margin-bottom: <?php echo $third; ?>px;
    }

    /* LOOP BLOCKS */

    .loop-blocks .post-box {
        margin-bottom: <?php echo $mid; ?>px;
    }
    ...
    .loop-blocks.style-default.content-sidebar .post-box:not(:last-child) {
        margin-bottom: <?php echo $single; ?>px;
    }

    .loop-blocks .content-headline {
        margin-bottom: <?php echo $third; ?>px;
    }

    .loop-blocks .content-text {
    ...
    .loop-blocks .post-box:hover .wp-post-image {
        transform: scale(0.97);
    }

    .loop-blocks .content .byline {
        margin-bottom: <?php echo $small; ?>px;
    }

    .loop-blocks .content-footer .avatar {
        top: -5px;
    }

    .loop-blocks .byline-author-name {
        font-weight: <?php echo $bold; ?>;
    }

    @media all and (min-width: 900px) {
        .loop-blocks.style-default.content-sidebar .post-box {
            padding: <?php echo $single; ?>px;
        }

        .loop-blocks.style-default.content-full .post-box {
            padding: <?php echo $mid; ?>px;
        }
    }
    ...
    @media all and (min-width: 700px) {
        ...
        .loop-blocks .content-footer-author {
            float: right;
        }

        .loop-blocks .byline-comments {
            margin-top: <?php echo $third; ?>px;
        }

        .loop-blocks.content-full .byline-comments {
    ...
    .archives-title .headline {
        margin-bottom: <?php echo $third; ?>px;
    }

    @media all and (min-width: 900px) {
        .archives-title.featured-image-cover {
            padding-top: <?php echo $double; ?>px;
        }
        ...
        .loop-blocks .archives-title:not(.featured-image-cover) .content-inner {
            max-width: 100%;
        }
    }
