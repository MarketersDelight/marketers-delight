<style type="text/css">
    ...
    .sidebar .widget:not(:last-child), .footer .widget:not(:last-child) {
    ...
    .accordion-group.active .accordion-title:after {
        content: '\e817';
    }
