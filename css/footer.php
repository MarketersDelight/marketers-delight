<style type="text/css">
	...
	<?php if ( ! empty( $typography['footer_title']['font_family'] ) ) : ?> font-family: <?php echo $typography['footer_title']['font_family']; ?>;
	<?php endif; ?> font-size: <?php echo $typography['footer_title']['font_size']['desktop']; ?>px;
	<?php if ( ! empty( $typography['footer_title']['font_weight'] ) ) : ?> font-weight: <?php echo $typography['footer_title']['font_weight']; ?>;
	<?php endif; ?> line-height: <?php echo $typography['footer_title']['line_height']['desktop']; ?>px;
