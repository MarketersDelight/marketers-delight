<style type="text/css">
    ...
    @media all and (min-width: 900px) {
        .content-full.style-minimal .breadcrumbs {
            text-align: center;
        }
    }
    ...
    .callout-button, .content-upgrade .button {
        width: 100%;
    }
    ...
    .share-notice-twitter.share-notice-outline .button-full {
        background-color: #1da1f2;
    }

    .share-notice-twitter.share-notice-outline .share-notice-icon,
    .share-notice-twitter.share-notice-full .button-full {
        color: #1da1f2;
    }
    ...
    .share-notice-facebook.share-notice-outline .button-full {
        background-color: #3b5998;
    }

    .share-notice-facebook.share-notice-outline .share-notice-icon,
    .share-notice-facebook.share-notice-full .button-full {
        color: #3b5998;
    }
    ...
    .share-notice-pinterest.share-notice-outline .button-full {
        background-color: #bd081c;
    }

    .share-notice-pinterest.share-notice-outline .share-notice-icon,
    .share-notice-pinterest.share-notice-full .button-full {
        color: #bd081c;
    }
    ...
    .share-notice-linkedin.share-notice-outline .button-full {
        background-color: #0077b5;
    }

    .share-notice-linkedin.share-notice-outline .share-notice-icon,
    .share-notice-linkedin.share-notice-full .button-full {
        color: #0077b5;
    }
    ...
    .byline a.byline-icon, .byline .byline-icon a {
        border-bottom: 0;
    }

    .byline-item .md-icon-twitter {
        color: #1da1f2;
    }
    ...
    .author-box .circle-icon {
        margin-right: <?php echo $small; ?>px;
    }

    .author-box .author-link:not(:last-child) {
    ...
    .author-link.twitter .md-icon-twitter {
        color: #fff;
    }
    ...
    <?php echo ( ! empty( $content['featured_image']['cover']['url'] ) ? 'background-image: url(\'' . esc_url( $content['featured_image']['cover']['url'] ) . '\'); ': '' ); ?> background-position: center center;
    ...
    .featured-image-cover<?php echo $text_class; ?> a {
        border-bottom-color: <?php echo esc_attr( $text_atts['border'] ); ?>;
    }
    ...
    @media all and (max-width: 900px) {
        ...
        .featured-image-cover<?php echo $text_colors['default']['class']; ?> .sub-menu > .menu-item > a {
            color: <?php echo esc_attr( $text_colors['default']['color'] ); ?>;
        }

        .featured-image-cover<?php echo $text_colors['alt']['class']; ?> .sub-menu > .menu-item > a {
            color: <?php echo esc_attr( $text_colors['alt']['color'] ); ?>;
        }
    }