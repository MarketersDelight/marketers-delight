...
.image-above-headline .page-image,
.image-below-headline .page-image { margin-bottom: <?php echo $half; ?>px; }
...
.image-above-headline .featured-image img { border-radius: 0 0 5px 5px; }
