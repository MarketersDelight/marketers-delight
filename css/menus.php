<style type="text/css">
    ...
    <?php if ( ! empty( $header['main_menu']['spacing_tb']  ) ) : ?> padding-bottom: <?php echo $header['main_menu']['spacing_tb']; ?>px;
        padding-top: <?php echo $header['main_menu']['spacing_tb']; ?>px;
    <?php endif; ?> <?php if ( ! empty( $header['main_menu']['spacing_lr']  ) ) : ?> padding-left: <?php echo $header['main_menu']['spacing_lr']; ?>px;
    ...
    .main-menu .menu-trigger, .main-menu .search-input, .main-menu-triggers .menu-trigger, .main-menu .search-submit, .menu-popup {
        color: <?php echo $colors['main_menu']['icons']; ?>;
    }
    ...
    .main-menu .menu.menu-social .menu-item a {
        color: <?php echo $colors['main_menu']['social']; ?>;
    }

    <?php endif; ?>

    @media all and (min-width: <?php echo $site_width; ?>px) {
        .menu-trigger, .menu-search {
        ...
        .menu-main .sub-menu, .menu-main > .current-menu-item > a, .menu-main > .menu-item-has-children > a:hover, .menu-main > .menu-item-has-children:hover > a {
            background-color: <?php echo $colors['main_menu']['sub_menu']; ?>;
        }
        ...
        .menu-main .current-menu-item a, .menu-main .menu-item-has-children:hover a, .menu-main .menu-item-has-children:hover .menu-item-desc, .menu-main .current-menu-item .menu-item-desc {
            color: <?php echo $colors['main_menu']['active']; ?>;
        }
