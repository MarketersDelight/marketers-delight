<style type="text/css">
	...
	<?php echo ( ! empty( $typography['header']['font_family'] ) ? "\tfont-family: " . $typography['header']['font_family'] . ";\n" : '' ); ?> <?php if ( ! empty( $typography['header']['font_size']['desktop'] ) ) : ?> font-size: <?php echo $typography['header']['font_size']['desktop']; ?>px;
	<?php endif; ?> <?php if ( ! empty( $typography['header']['font_weight'] ) ) : ?> font-weight: <?php echo $typography['header']['font_weight']; ?>;
	<?php endif; ?> <?php if ( ! empty( $typography['header']['line_height']['desktop'] ) ) : ?> line-height: <?php echo $typography['header']['line_height']['desktop']; ?>px;
	...
	.header .site-title, .header .site-title:hover {
		color: <?php echo $colors['header']['site_title']; ?>;
	}

	.custom-logo-link {
		position: relative;
	<?php echo ( ! empty( $header['logo_width']['desktop'] ) ? 'width: ' . $header['logo_width']['desktop'] . 'px;' : '' ); ?> z-index: 10;
	}
	...
	<?php echo ( ! empty( $typography['site_tagline']['font_style'] ) ? "\tfont-style: italic;\n" : '' ); ?> <?php echo ( ! empty( $typography['site_tagline']['font_weight'] ) ? "\tfont-weight " . $typography['site_tagline']['font_weight'] . ';' : '' ); ?> line-height: <?php echo $typography['site_tagline']['line_height']['desktop'] ; ?>px;
	}
	...
	.menu-header > .menu-item.current-menu-item > a {
		color: <?php echo $colors['header']['menu']['active']; ?>;
	}
	...
	.header .button, .header .button:hover, .menu-header > .current-menu-item.button > a {
		color: #fff;
	}
	...
	@media all and (min-width: 900px) {
		...
		.menu-header .sub-menu a {
			color: <?php echo $colors['header']['submenu']['links']; ?>;
		}
	...
	@media all and (max-width: 900px) {
		.header {
		<?php if ( ! empty( $typography['header']['font_size']['tablet'] ) ) : ?> font-size: <?php echo $typography['header']['font_size']['tablet']; ?>px;
		<?php endif; ?> <?php if ( ! empty( $typography['header']['line_height']['tablet'] ) ) : ?> line-height: <?php echo $typography['header']['line_height']['tablet']; ?>px;
		<?php endif; ?> padding-bottom: <?php echo $header['spacing_top']['tablet']; ?>px;
	...
	<?php if ( ! empty( $header['logo_width']['tablet'] ) ) : ?>
		.custom-logo-link {
			width: <?php echo $header['logo_width']['tablet']; ?>px;
		}
	...
	@media all and (max-width: 700px) {
		.header {
		<?php if ( ! empty( $typography['header']['font_size']['mobile'] ) ) : ?> font-size: <?php echo $typography['header']['font_size']['mobile']; ?>px;
		<?php endif; ?> <?php if ( ! empty( $typography['header']['line_height']['mobile'] ) ) : ?> line-height: <?php echo $typography['header']['line_height']['mobile']; ?>px;
		<?php endif; ?> padding-bottom: <?php echo $header['spacing_top']['mobile']; ?>px;
	...
	<?php if ( ! empty( $header['logo_width']['mobile'] ) ) : ?>
		.custom-logo-link {
			width: <?php echo $header['logo_width']['mobile']; ?>px;
		}
