<style type="text/css">
    ...
    @media all and (min-width: 900px) {
        .aligncenter.wrap, .alignleft.wrap, .alignfull {
            margin-left: -<?php echo $double; ?>px;
        }

        .aligncenter.wrap, .alignright.wrap, .alignfull {
            margin-right: -<?php echo $double; ?>px;
        }

        .aligncenter.wrap-small, .alignleft.wrap-small, .alignwide {
            margin-left: -<?php echo $single; ?>px;
        }

        .aligncenter.wrap-small, .alignlright.wrap-small, .alignwide {
            margin-right: -<?php echo $single; ?>px;
        }

        .content-full .aligncenter.wrap, .content-full .alignleft.wrap, .content-full .alignfull {
            margin-left: -<?php echo $breakout; ?>%;
        }

        .content-full .aligncenter.wrap, .content-full .alignright.wrap, .content-full .alignfull {
            margin-right: -<?php echo $breakout; ?>%;
        }
