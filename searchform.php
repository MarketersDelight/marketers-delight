...
?>
<form role="search" method="get" id="searchform" class="search-form form-attached clear"
      action="<?php echo home_url('/'); ?>">
    <input type="search" class="search-input form-input" placeholder="<?php echo esc_attr($label); ?>"
    ...
    <?php endif; ?>
    <button type="submit" class="search-submit form-submit <?php echo md_icon('search', true); ?>"
